...
async function main() {
    ...
    privateCausesRouter.use(newSessionMiddleware(SessionLevel.SessionAndUser, identityClient));
    ...
    privateUserActionsOverviewRouter.use(newSessionMiddleware(SessionLevel.SessionAndUser, identityClient));
